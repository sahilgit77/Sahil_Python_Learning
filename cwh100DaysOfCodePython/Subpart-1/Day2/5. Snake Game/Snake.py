...
#Highscore Build
   if(not os.path.exists("../../../../../PycharmProjects/pythonProject/CWH-SK-python/highscore.txt")):
       with open("../../../../../PycharmProjects/pythonProject/CWH-SK-python/highscore.txt", "w") as f:
           f.write("0")
   with open("../../../../../PycharmProjects/pythonProject/CWH-SK-python/highscore.txt", "r") as f:
            highscore = f.read()
